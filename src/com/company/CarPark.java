...
public class CarPark {
    ...
    public CarPark() {
        MessageCenter.DebugMessage("Creating a CarPark");
    ...
    public Double CalculateDailyRevenue() {
        ...
        for (Vehicle currentCar : listOfCars) {
            MessageCenter.DebugMessage(String.format("Calcilating for %s : %s ", currentCar.getManufacturer(), currentCar.getModelName()));
            totalRevenue += charge;
        }
